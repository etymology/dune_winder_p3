...
class VTemplateGCodeTests(unittest.TestCase):
  ...
  def test_default_render_matches_expected_spec_edges(self):
    ...
    self.assertEqual(
      ...
      [
        "N0 ( V Layer )",
        "N1 (HEAD RESTART) X440 Y0",
        "N2 G106 P3",
        "N3 (0, ) F1000 G103 PB400 PB399 PXY G105 PY30 ( BOARD GAP )",
    ...
    self.assertEqual(
      lines[-8:],
      [
        "N" + str(tail_start) + " (400,16) G109 PF400 PRT G103 PB2398 PB2399 PX (Top B corner - head end)",
        "N" + str(tail_start + 1) + " (400,17) G103 PB2398 PB2399 PY G105 PY-60",
        "N" + str(tail_start + 2) + " (400,18) G103 PB2398 PB2399 PY G105 PY0 G111",
        "N" + str(tail_start + 3) + " (400,19) X440 Y2315 F300",
        "N" + str(tail_start + 4) + " (400,20) G106 P0",
        "N" + str(tail_start + 5) + " (400,21) X440 Y2335",
        "N" + str(tail_start + 6) + " (400,22) X650 Y2335 G111",
        "N" + str(tail_start + 7) + " (400,23) X440 Y2335",
      ],
    )
  ...
  def test_named_inputs_and_special_aliases_remain_usable(self):
    ...
    self.assertIn(
      "N23 (1,20) G109 PB399 PBR G103 PF1 PF2 PY G105 PY7 (Head A corner)",
      special_lines,
    )
  ...
  def test_offset_vector_maps_to_all_twelve_adjustment_sites(self):
    ...
    expected_first_wrap = [
      ...
      "N7 (1,4) G109 PB1999 PLT G103 PF800 PF799 PX G105 PX2 (Top A corner - foot end)",
      "N9 (1,6) G109 PF800 PRB G103 PF1600 PF1599 PXY G105 PY3 G102 G108 ( BOARD GAP ) (Foot A corner)",
      "N11 (1,8) G109 PF1599 PBL G103 PB1200 PB1201 PY G105 PY4 (Foot B corner)",
      "N13 (1,10) G109 PB1200 PTR G103 PB1199 PB1198 PXY G105 PX5 G102 G108 (Bottom B corner - foot end)",
      "N15 (1,12) G109 PB1199 PBR G103 PF1599 PF1600 PX G105 PX6 (Bottom A corner - foot end)",
      "N17 (1,14) G109 PF1600 PLT G103 PF799 PF798 PXY G105 PX7 G102 G108 (Top A corner - head end)",
      "N19 (1,16) G109 PF799 PRT G103 PB1999 PB2000 PX G105 PX8 (Top B corner - head end)",
      "N21 (1,18) (HEAD RESTART) G109 PB2000 PLB G103 PB400 PB399 PXY G105 PY9 G102 G108 ( BOARD GAP )",
      "N23 (1,20) G109 PB399 PBR G103 PF1 PF2 PY G105 PY10 (Head A corner)",
      "N25 (1,22) G109 PF1 PTL G103 PF2398 PF2397 PXY G105 PX11 G102 G108 (Bottom A corner - head end)",
      "N27 (1,24) G109 PF2398 PBL G103 PB400 PB401 G105 PX13 PX12 (Bottom B corner - head end)",
    ]
