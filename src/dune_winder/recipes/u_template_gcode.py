...
U_WRAP_SCRIPT = compile_template_script(
  (
    ...
    "emit G113 PPRECISE G103 PF${800 + wrap} PF${801 + wrap} PY G105 ${coord('PY', -Y_PULL_IN)}",
    "if near_comb(799 + wrap): emit G113 PPRECISE G103 PF${800 + wrap} PF${801 + wrap} PX G105 ${coord('PX-', Y_PULL_IN * COMB_PULL_FACTOR)}",
    ...
    "emit G113 PPRECISE G103 PB${400 + wrap} PB${401 + wrap} PX G105 ${coord('PY', Y_PULL_IN)}",
    ...
    "transfer b_to_a_transfer",
    "emit G113 PPRECISE G109 PB${401 - wrap} PLT G103 PF${wrap} PF${2400 + wrap} PXY ${offset('PY', offsets[5])} (Head A corner, rewind)",
    "emit G113 PPRECISE G103 PF${1 + wrap} PF${wrap} PY G105 ${coord('PX', X_PULL_IN)} ( BOARD GAP )",
    ...
    "emit G113 PPRECISE G103 PB${2002 + wrap} PB${2003 + wrap} PY G105 ${coord('PY', -Y_PULL_IN)}",
    "if near_comb(1999 + wrap): emit G113 PPRECISE G103 PB${2002 + wrap} PB${2003 + wrap} PX G105 ${coord('PX', Y_PULL_IN * COMB_PULL_FACTOR)}",
    ...
    "emit G113 PPRECISE G103 PF${1601 + wrap} PF${1602 + wrap} PY G105 ${coord('PY', Y_PULL_IN)}",
    "if near_comb(1601 + wrap): emit G113 PPRECISE G103 PF${1601 + wrap} PF${1602 + wrap} PX G105 ${coord('PX', X_PULL_IN * COMB_PULL_FACTOR)}",
    ...
    "emit G113 PPRECISE G103 PB${1201 + wrap} PB${1200 + wrap} PX G105 ${coord('PX', -X_PULL_IN)}",
  )
)
